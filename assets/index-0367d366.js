...
`,G=s.span`
  background-color: inherit;
`;function X(){const{data:t,isLoading:o}=m({queryKey:["allCoins"],queryFn:O});return e.jsxs(e.Fragment,{children:[e.jsx(b,{children:e.jsx("title",{children:$("Home")})}),e.jsx(W,{children:e.jsx(E,{children:"Coins"})}),e.jsx(U,{children:o?e.jsx("h3",{children:"Loading..."}):e.jsx(K,{children:t==null?void 0:t.map(n=>e.jsx(Q,{children:e.jsxs(h,{to:`/${n.id}`,state:{coinName:n.name},children:[e.jsx(V,{src:v(n.symbol.toLowerCase())}),e.jsx(G,{children:n.name})]})},n.id))})})]})}const I={colors:{bg:"#23262F",card:"#393C44",text:"#F0F0F1",subText:"#7B7D82",activeTab:"#58BC7C",activeText:"#000",hoverTab:"#94CA75"}},D={colors:{bg:"#F6F6F6",card:"#FFFFFF",text:"#23262F",subText:"#919297",activeTab:"#58BC7C",activeText:"#000",hoverTab:"#94CA75"}},J=R({key:"isDark",default:!0}),Y=B`
  ${z}
  * {
